...
type WhySearchRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Attributes    string                 `protobuf:"bytes,1,opt,name=attributes,proto3" json:"attributes,omitempty"`
	EntityId      int64                  `protobuf:"varint,2,opt,name=entity_id,json=entityId,proto3" json:"entity_id,omitempty"`
	SearchProfile string                 `protobuf:"bytes,3,opt,name=search_profile,json=searchProfile,proto3" json:"search_profile,omitempty"`
	Flags         int64                  `protobuf:"varint,4,opt,name=flags,proto3" json:"flags,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WhySearchRequest) Reset() {
	*x = WhySearchRequest{}
...
func (x *WhySearchRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WhySearchRequest) ProtoMessage() {}

func (x *WhySearchRequest) ProtoReflect() protoreflect.Message {
	mi := &file_szengine_proto_msgTypes[58]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WhySearchRequest.ProtoReflect.Descriptor instead.
func (*WhySearchRequest) Descriptor() ([]byte, []int) {
	return file_szengine_proto_rawDescGZIP(), []int{58}
}

func (x *WhySearchRequest) GetAttributes() string {
	if x != nil {
		return x.Attributes
	}
	return ""
...
func (x *WhySearchRequest) GetEntityId() int64 {
	if x != nil {
		return x.EntityId
	}
	return 0
...
func (x *WhySearchRequest) GetSearchProfile() string {
	if x != nil {
		return x.SearchProfile
	}
	return ""
...
func (x *WhySearchRequest) GetFlags() int64 {
	if x != nil {
		return x.Flags
	}
	return 0
...
func (x *WhySearchResponse) Reset() {
	*x = WhySearchResponse{}
...
func (x *WhySearchResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WhySearchResponse) ProtoMessage() {}

func (x *WhySearchResponse) ProtoReflect() protoreflect.Message {
	mi := &file_szengine_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WhySearchResponse.ProtoReflect.Descriptor instead.
func (*WhySearchResponse) Descriptor() ([]byte, []int) {
	return file_szengine_proto_rawDescGZIP(), []int{59}
}

func (x *WhySearchResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
const file_szengine_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\tR\x06result2\xec\x16\n" +
	"\bSzEngine\x12F\n" +
	...
	"\fDeleteRecord\x12\x1d.szengine.DeleteRecordRequest\x1a\x1e.szengine.DeleteRecordResponse\"\x00\x12\x8e\x01\n" +
	...
	"\n" +
	"WhyRecords\x12\x1b.szengine.WhyRecordsRequest\x1a\x1c.szengine.WhyRecordsResponse\"\x00\x12F\n" +
	"\tWhySearch\x12\x1a.szengine.WhySearchRequest\x1a\x1b.szengine.WhySearchResponse\"\x00B^\n" +
	"\x1acom.senzing.sdk.grpc.protoB\rSzEngineProtoZ1github.com/senzing-garage/sz-sdk-go-grpc/szengineb\x06proto3"
...
var file_szengine_proto_goTypes = []any{
	...
	(*CountRedoRecordsRequest)(nil),                   // 2: szengine.CountRedoRecordsRequest
	(*CountRedoRecordsResponse)(nil),                  // 3: szengine.CountRedoRecordsResponse
	(*DeleteRecordRequest)(nil),                       // 4: szengine.DeleteRecordRequest
	(*DeleteRecordResponse)(nil),                      // 5: szengine.DeleteRecordResponse
	(*FindInterestingEntitiesByEntityIdRequest)(nil),  // 6: szengine.FindInterestingEntitiesByEntityIdRequest
	(*FindInterestingEntitiesByEntityIdResponse)(nil), // 7: szengine.FindInterestingEntitiesByEntityIdResponse
	(*FindInterestingEntitiesByRecordIdRequest)(nil),  // 8: szengine.FindInterestingEntitiesByRecordIdRequest
	(*FindInterestingEntitiesByRecordIdResponse)(nil), // 9: szengine.FindInterestingEntitiesByRecordIdResponse
	(*FindNetworkByEntityIdRequest)(nil),              // 10: szengine.FindNetworkByEntityIdRequest
	(*FindNetworkByEntityIdResponse)(nil),             // 11: szengine.FindNetworkByEntityIdResponse
	(*FindNetworkByRecordIdRequest)(nil),              // 12: szengine.FindNetworkByRecordIdRequest
	(*FindNetworkByRecordIdResponse)(nil),             // 13: szengine.FindNetworkByRecordIdResponse
	(*FindPathByEntityIdRequest)(nil),                 // 14: szengine.FindPathByEntityIdRequest
	(*FindPathByEntityIdResponse)(nil),                // 15: szengine.FindPathByEntityIdResponse
	(*FindPathByRecordIdRequest)(nil),                 // 16: szengine.FindPathByRecordIdRequest
	(*FindPathByRecordIdResponse)(nil),                // 17: szengine.FindPathByRecordIdResponse
	(*GetActiveConfigIdRequest)(nil),                  // 18: szengine.GetActiveConfigIdRequest
	(*GetActiveConfigIdResponse)(nil),                 // 19: szengine.GetActiveConfigIdResponse
	(*GetEntityByEntityIdRequest)(nil),                // 20: szengine.GetEntityByEntityIdRequest
	(*GetEntityByEntityIdResponse)(nil),               // 21: szengine.GetEntityByEntityIdResponse
	(*GetEntityByRecordIdRequest)(nil),                // 22: szengine.GetEntityByRecordIdRequest
	(*GetEntityByRecordIdResponse)(nil),               // 23: szengine.GetEntityByRecordIdResponse
	(*GetRecordPreviewRequest)(nil),                   // 24: szengine.GetRecordPreviewRequest
	(*GetRecordPreviewResponse)(nil),                  // 25: szengine.GetRecordPreviewResponse
	(*GetRecordRequest)(nil),                          // 26: szengine.GetRecordRequest
	(*GetRecordResponse)(nil),                         // 27: szengine.GetRecordResponse
	(*GetRedoRecordRequest)(nil),                      // 28: szengine.GetRedoRecordRequest
	(*GetRedoRecordResponse)(nil),                     // 29: szengine.GetRedoRecordResponse
	(*GetStatsRequest)(nil),                           // 30: szengine.GetStatsRequest
	(*GetStatsResponse)(nil),                          // 31: szengine.GetStatsResponse
	...
	(*StreamExportCsvEntityReportRequest)(nil),        // 48: szengine.StreamExportCsvEntityReportRequest
	(*StreamExportCsvEntityReportResponse)(nil),       // 49: szengine.StreamExportCsvEntityReportResponse
	(*StreamExportJsonEntityReportRequest)(nil),       // 50: szengine.StreamExportJsonEntityReportRequest
	(*StreamExportJsonEntityReportResponse)(nil),      // 51: szengine.StreamExportJsonEntityReportResponse
	(*WhyEntitiesRequest)(nil),                        // 52: szengine.WhyEntitiesRequest
	(*WhyEntitiesResponse)(nil),                       // 53: szengine.WhyEntitiesResponse
	(*WhyRecordInEntityRequest)(nil),                  // 54: szengine.WhyRecordInEntityRequest
	(*WhyRecordInEntityResponse)(nil),                 // 55: szengine.WhyRecordInEntityResponse
	(*WhyRecordsRequest)(nil),                         // 56: szengine.WhyRecordsRequest
	(*WhyRecordsResponse)(nil),                        // 57: szengine.WhyRecordsResponse
	(*WhySearchRequest)(nil),                          // 58: szengine.WhySearchRequest
	(*WhySearchResponse)(nil),                         // 59: szengine.WhySearchResponse
}
var file_szengine_proto_depIdxs = []int32{
	0,  // 0: szengine.SzEngine.AddRecord:input_type -> szengine.AddRecordRequest
	2,  // 1: szengine.SzEngine.CountRedoRecords:input_type -> szengine.CountRedoRecordsRequest
	4,  // 2: szengine.SzEngine.DeleteRecord:input_type -> szengine.DeleteRecordRequest
	6,  // 3: szengine.SzEngine.FindInterestingEntitiesByEntityId:input_type -> szengine.FindInterestingEntitiesByEntityIdRequest
	8,  // 4: szengine.SzEngine.FindInterestingEntitiesByRecordId:input_type -> szengine.FindInterestingEntitiesByRecordIdRequest
	10, // 5: szengine.SzEngine.FindNetworkByEntityId:input_type -> szengine.FindNetworkByEntityIdRequest
	12, // 6: szengine.SzEngine.FindNetworkByRecordId:input_type -> szengine.FindNetworkByRecordIdRequest
	14, // 7: szengine.SzEngine.FindPathByEntityId:input_type -> szengine.FindPathByEntityIdRequest
	16, // 8: szengine.SzEngine.FindPathByRecordId:input_type -> szengine.FindPathByRecordIdRequest
	18, // 9: szengine.SzEngine.GetActiveConfigId:input_type -> szengine.GetActiveConfigIdRequest
	20, // 10: szengine.SzEngine.GetEntityByEntityId:input_type -> szengine.GetEntityByEntityIdRequest
	22, // 11: szengine.SzEngine.GetEntityByRecordId:input_type -> szengine.GetEntityByRecordIdRequest
	26, // 12: szengine.SzEngine.GetRecord:input_type -> szengine.GetRecordRequest
	24, // 13: szengine.SzEngine.GetRecordPreview:input_type -> szengine.GetRecordPreviewRequest
	28, // 14: szengine.SzEngine.GetRedoRecord:input_type -> szengine.GetRedoRecordRequest
	30, // 15: szengine.SzEngine.GetStats:input_type -> szengine.GetStatsRequest
	32, // 16: szengine.SzEngine.GetVirtualEntityByRecordId:input_type -> szengine.GetVirtualEntityByRecordIdRequest
	34, // 17: szengine.SzEngine.HowEntityByEntityId:input_type -> szengine.HowEntityByEntityIdRequest
	36, // 18: szengine.SzEngine.PrimeEngine:input_type -> szengine.PrimeEngineRequest
	38, // 19: szengine.SzEngine.ProcessRedoRecord:input_type -> szengine.ProcessRedoRecordRequest
	40, // 20: szengine.SzEngine.ReevaluateEntity:input_type -> szengine.ReevaluateEntityRequest
	42, // 21: szengine.SzEngine.ReevaluateRecord:input_type -> szengine.ReevaluateRecordRequest
	44, // 22: szengine.SzEngine.Reinitialize:input_type -> szengine.ReinitializeRequest
	46, // 23: szengine.SzEngine.SearchByAttributes:input_type -> szengine.SearchByAttributesRequest
	48, // 24: szengine.SzEngine.StreamExportCsvEntityReport:input_type -> szengine.StreamExportCsvEntityReportRequest
	50, // 25: szengine.SzEngine.StreamExportJsonEntityReport:input_type -> szengine.StreamExportJsonEntityReportRequest
	52, // 26: szengine.SzEngine.WhyEntities:input_type -> szengine.WhyEntitiesRequest
	54, // 27: szengine.SzEngine.WhyRecordInEntity:input_type -> szengine.WhyRecordInEntityRequest
	56, // 28: szengine.SzEngine.WhyRecords:input_type -> szengine.WhyRecordsRequest
	58, // 29: szengine.SzEngine.WhySearch:input_type -> szengine.WhySearchRequest
	1,  // 30: szengine.SzEngine.AddRecord:output_type -> szengine.AddRecordResponse
	3,  // 31: szengine.SzEngine.CountRedoRecords:output_type -> szengine.CountRedoRecordsResponse
	5,  // 32: szengine.SzEngine.DeleteRecord:output_type -> szengine.DeleteRecordResponse
	7,  // 33: szengine.SzEngine.FindInterestingEntitiesByEntityId:output_type -> szengine.FindInterestingEntitiesByEntityIdResponse
	9,  // 34: szengine.SzEngine.FindInterestingEntitiesByRecordId:output_type -> szengine.FindInterestingEntitiesByRecordIdResponse
	11, // 35: szengine.SzEngine.FindNetworkByEntityId:output_type -> szengine.FindNetworkByEntityIdResponse
	13, // 36: szengine.SzEngine.FindNetworkByRecordId:output_type -> szengine.FindNetworkByRecordIdResponse
	15, // 37: szengine.SzEngine.FindPathByEntityId:output_type -> szengine.FindPathByEntityIdResponse
	17, // 38: szengine.SzEngine.FindPathByRecordId:output_type -> szengine.FindPathByRecordIdResponse
	19, // 39: szengine.SzEngine.GetActiveConfigId:output_type -> szengine.GetActiveConfigIdResponse
	21, // 40: szengine.SzEngine.GetEntityByEntityId:output_type -> szengine.GetEntityByEntityIdResponse
	23, // 41: szengine.SzEngine.GetEntityByRecordId:output_type -> szengine.GetEntityByRecordIdResponse
	27, // 42: szengine.SzEngine.GetRecord:output_type -> szengine.GetRecordResponse
	25, // 43: szengine.SzEngine.GetRecordPreview:output_type -> szengine.GetRecordPreviewResponse
	29, // 44: szengine.SzEngine.GetRedoRecord:output_type -> szengine.GetRedoRecordResponse
	31, // 45: szengine.SzEngine.GetStats:output_type -> szengine.GetStatsResponse
	33, // 46: szengine.SzEngine.GetVirtualEntityByRecordId:output_type -> szengine.GetVirtualEntityByRecordIdResponse
	35, // 47: szengine.SzEngine.HowEntityByEntityId:output_type -> szengine.HowEntityByEntityIdResponse
	37, // 48: szengine.SzEngine.PrimeEngine:output_type -> szengine.PrimeEngineResponse
	39, // 49: szengine.SzEngine.ProcessRedoRecord:output_type -> szengine.ProcessRedoRecordResponse
	41, // 50: szengine.SzEngine.ReevaluateEntity:output_type -> szengine.ReevaluateEntityResponse
	43, // 51: szengine.SzEngine.ReevaluateRecord:output_type -> szengine.ReevaluateRecordResponse
	45, // 52: szengine.SzEngine.Reinitialize:output_type -> szengine.ReinitializeResponse
	47, // 53: szengine.SzEngine.SearchByAttributes:output_type -> szengine.SearchByAttributesResponse
	49, // 54: szengine.SzEngine.StreamExportCsvEntityReport:output_type -> szengine.StreamExportCsvEntityReportResponse
	51, // 55: szengine.SzEngine.StreamExportJsonEntityReport:output_type -> szengine.StreamExportJsonEntityReportResponse
	53, // 56: szengine.SzEngine.WhyEntities:output_type -> szengine.WhyEntitiesResponse
	55, // 57: szengine.SzEngine.WhyRecordInEntity:output_type -> szengine.WhyRecordInEntityResponse
	57, // 58: szengine.SzEngine.WhyRecords:output_type -> szengine.WhyRecordsResponse
	59, // 59: szengine.SzEngine.WhySearch:output_type -> szengine.WhySearchResponse
