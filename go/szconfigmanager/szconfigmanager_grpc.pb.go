...
const (
	...
	SzConfigManager_GetConfigRegistry_FullMethodName      = "/szconfigmanager.SzConfigManager/GetConfigRegistry"
...
type SzConfigManagerClient interface {
	...
	GetConfigRegistry(ctx context.Context, in *GetConfigRegistryRequest, opts ...grpc.CallOption) (*GetConfigRegistryResponse, error)
...
func (c *szConfigManagerClient) GetConfigRegistry(ctx context.Context, in *GetConfigRegistryRequest, opts ...grpc.CallOption) (*GetConfigRegistryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetConfigRegistryResponse)
	err := c.cc.Invoke(ctx, SzConfigManager_GetConfigRegistry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SzConfigManagerServer interface {
	...
	GetConfigRegistry(context.Context, *GetConfigRegistryRequest) (*GetConfigRegistryResponse, error)
...
func (UnimplementedSzConfigManagerServer) GetConfigRegistry(context.Context, *GetConfigRegistryRequest) (*GetConfigRegistryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetConfigRegistry not implemented")
}
func (UnimplementedSzConfigManagerServer) GetDefaultConfigId(context.Context, *GetDefaultConfigIdRequest) (*GetDefaultConfigIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDefaultConfigId not implemented")
}
...
func (UnimplementedSzConfigManagerServer) RegisterConfig(context.Context, *RegisterConfigRequest) (*RegisterConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterConfig not implemented")
}
func (UnimplementedSzConfigManagerServer) ReplaceDefaultConfigId(context.Context, *ReplaceDefaultConfigIdRequest) (*ReplaceDefaultConfigIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReplaceDefaultConfigId not implemented")
}
func (UnimplementedSzConfigManagerServer) SetDefaultConfig(context.Context, *SetDefaultConfigRequest) (*SetDefaultConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetDefaultConfig not implemented")
}
func (UnimplementedSzConfigManagerServer) SetDefaultConfigId(context.Context, *SetDefaultConfigIdRequest) (*SetDefaultConfigIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetDefaultConfigId not implemented")
}
...
func RegisterSzConfigManagerServer(s grpc.ServiceRegistrar, srv SzConfigManagerServer) {
	// If the following call panics, it indicates UnimplementedSzConfigManagerServer was
...
func _SzConfigManager_GetConfigRegistry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetConfigRegistryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SzConfigManagerServer).GetConfigRegistry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SzConfigManager_GetConfigRegistry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SzConfigManagerServer).GetConfigRegistry(ctx, req.(*GetConfigRegistryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SzConfigManager_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetConfigRegistry",
			Handler:    _SzConfigManager_GetConfigRegistry_Handler,
		},
		{
