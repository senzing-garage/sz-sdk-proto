...
const file_szconfig_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\tR\x06result2\x92\x02\n" +
	"\bSzConfig\x12R\n" +
	...
	"\x0eGetDataSources\x12\x1f.szconfig.GetDataSourcesRequest\x1a .szconfig.GetDataSourcesResponse\"\x00BX\n" +
...
var file_szconfig_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_szconfig_proto_depIdxs = []int32{
	...
	1, // 3: szconfig.SzConfig.AddDataSource:output_type -> szconfig.AddDataSourceResponse
	3, // 4: szconfig.SzConfig.DeleteDataSource:output_type -> szconfig.DeleteDataSourceResponse
	5, // 5: szconfig.SzConfig.GetDataSources:output_type -> szconfig.GetDataSourcesResponse
