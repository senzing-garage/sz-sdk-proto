...
func (UnimplementedSzDiagnosticServer) CheckRepositoryPerformance(context.Context, *CheckRepositoryPerformanceRequest) (*CheckRepositoryPerformanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckRepositoryPerformance not implemented")
}
...
func (UnimplementedSzDiagnosticServer) PurgeRepository(context.Context, *PurgeRepositoryRequest) (*PurgeRepositoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PurgeRepository not implemented")
}
...
func RegisterSzDiagnosticServer(s grpc.ServiceRegistrar, srv SzDiagnosticServer) {
	// If the following call panics, it indicates UnimplementedSzDiagnosticServer was
