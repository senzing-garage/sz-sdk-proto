...
module G2product
  module G2Diagnostic
    class Service
      ...
      rpc :GetLastException, ::G2product::GetLastExceptionRequest, ::G2product::GetLastExceptionResponse
      rpc :GetLastExceptionCode, ::G2product::GetLastExceptionCodeRequest, ::G2product::GetLastExceptionCodeResponse
