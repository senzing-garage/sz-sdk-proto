...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("szengine.proto", :syntax => :proto3) do
    ...
    add_message "szengine.GetRecordPreviewRequest" do
      optional :record_definition, :string, 1
      optional :flags, :int64, 2
    end
    add_message "szengine.GetRecordPreviewResponse" do
      optional :result, :string, 1
    end
...
module Szengine
  ...
  GetRecordPreviewRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("szengine.GetRecordPreviewRequest").msgclass
  GetRecordPreviewResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("szengine.GetRecordPreviewResponse").msgclass
