...
def add_G2SsadmServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ClearLastException': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=g2ssadm__pb2.ClearLastExceptionRequest.FromString,
                    response_serializer=g2ssadm__pb2.ClearLastExceptionResponse.SerializeToString,
            ),
            ...
            'GetLastException': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=g2ssadm__pb2.GetLastExceptionRequest.FromString,
                    response_serializer=g2ssadm__pb2.GetLastExceptionResponse.SerializeToString,
            ),
            'GetLastExceptionCode': grpc.unary_unary_rpc_method_handler(
                    servicer.GetLastExceptionCode,
                    request_deserializer=g2ssadm__pb2.GetLastExceptionCodeRequest.FromString,
                    response_serializer=g2ssadm__pb2.GetLastExceptionCodeResponse.SerializeToString,
            ),
