...
class G2Config final {
 public:
  ...
  typedef WithAsyncMethod_AddDataSource<WithAsyncMethod_Close<WithAsyncMethod_Create<WithAsyncMethod_DeleteDataSource<WithAsyncMethod_Destroy<WithAsyncMethod_Init<WithAsyncMethod_ListDataSources<WithAsyncMethod_Load<WithAsyncMethod_Save<Service > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_AddDataSource<WithCallbackMethod_Close<WithCallbackMethod_Create<WithCallbackMethod_DeleteDataSource<WithCallbackMethod_Destroy<WithCallbackMethod_Init<WithCallbackMethod_ListDataSources<WithCallbackMethod_Load<WithCallbackMethod_Save<Service > > > > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_AddDataSource<WithStreamedUnaryMethod_Close<WithStreamedUnaryMethod_Create<WithStreamedUnaryMethod_DeleteDataSource<WithStreamedUnaryMethod_Destroy<WithStreamedUnaryMethod_Init<WithStreamedUnaryMethod_ListDataSources<WithStreamedUnaryMethod_Load<WithStreamedUnaryMethod_Save<Service > > > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_AddDataSource<WithStreamedUnaryMethod_Close<WithStreamedUnaryMethod_Create<WithStreamedUnaryMethod_DeleteDataSource<WithStreamedUnaryMethod_Destroy<WithStreamedUnaryMethod_Init<WithStreamedUnaryMethod_ListDataSources<WithStreamedUnaryMethod_Load<WithStreamedUnaryMethod_Save<Service > > > > > > > > > StreamedService;
};
