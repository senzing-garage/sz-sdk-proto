...
class G2Ssadm final {
 public:
  ...
  typedef WithAsyncMethod_CreateSaltInStore<WithAsyncMethod_Destroy<WithAsyncMethod_Init<WithAsyncMethod_InitializeNewToken<WithAsyncMethod_List<WithAsyncMethod_Put<WithAsyncMethod_ReinitializeToken<WithAsyncMethod_SetupStore<Service > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_CreateSaltInStore<WithCallbackMethod_Destroy<WithCallbackMethod_Init<WithCallbackMethod_InitializeNewToken<WithCallbackMethod_List<WithCallbackMethod_Put<WithCallbackMethod_ReinitializeToken<WithCallbackMethod_SetupStore<Service > > > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_CreateSaltInStore<WithStreamedUnaryMethod_Destroy<WithStreamedUnaryMethod_Init<WithStreamedUnaryMethod_InitializeNewToken<WithStreamedUnaryMethod_List<WithStreamedUnaryMethod_Put<WithStreamedUnaryMethod_ReinitializeToken<WithStreamedUnaryMethod_SetupStore<Service > > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_CreateSaltInStore<WithStreamedUnaryMethod_Destroy<WithStreamedUnaryMethod_Init<WithStreamedUnaryMethod_InitializeNewToken<WithStreamedUnaryMethod_List<WithStreamedUnaryMethod_Put<WithStreamedUnaryMethod_ReinitializeToken<WithStreamedUnaryMethod_SetupStore<Service > > > > > > > > StreamedService;
};
