...
class GetConfigsRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:szconfigmanager.GetConfigsRequest) */ {
 public:
  inline GetConfigsRequest() : GetConfigsRequest(nullptr) {}
  explicit PROTOBUF_CONSTEXPR GetConfigsRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  GetConfigsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class GetConfigsResponse final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GetConfigsResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  GetConfigsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetConfigsResponse::set_result(ArgT0&& arg0, ArgT... args) {
