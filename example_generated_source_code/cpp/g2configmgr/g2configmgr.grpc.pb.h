...
class G2ConfigMgr final {
 public:
  ...
  typedef WithAsyncMethod_AddConfig<WithAsyncMethod_Destroy<WithAsyncMethod_GetConfig<WithAsyncMethod_GetConfigList<WithAsyncMethod_GetDefaultConfigID<WithAsyncMethod_Init<WithAsyncMethod_ReplaceDefaultConfigID<WithAsyncMethod_SetDefaultConfigID<Service > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_AddConfig<WithCallbackMethod_Destroy<WithCallbackMethod_GetConfig<WithCallbackMethod_GetConfigList<WithCallbackMethod_GetDefaultConfigID<WithCallbackMethod_Init<WithCallbackMethod_ReplaceDefaultConfigID<WithCallbackMethod_SetDefaultConfigID<Service > > > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_AddConfig<WithStreamedUnaryMethod_Destroy<WithStreamedUnaryMethod_GetConfig<WithStreamedUnaryMethod_GetConfigList<WithStreamedUnaryMethod_GetDefaultConfigID<WithStreamedUnaryMethod_Init<WithStreamedUnaryMethod_ReplaceDefaultConfigID<WithStreamedUnaryMethod_SetDefaultConfigID<Service > > > > > > > > StreamedUnaryService;
