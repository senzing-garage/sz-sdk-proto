...
class G2Hasher final {
 public:
  ...
  typedef WithAsyncMethod_Destroy<WithAsyncMethod_ExportTokenLibrary<WithAsyncMethod_Init<WithAsyncMethod_InitWithConfig<WithAsyncMethod_Process<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Destroy<WithCallbackMethod_ExportTokenLibrary<WithCallbackMethod_Init<WithCallbackMethod_InitWithConfig<WithCallbackMethod_Process<Service > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_Destroy<WithStreamedUnaryMethod_ExportTokenLibrary<WithStreamedUnaryMethod_Init<WithStreamedUnaryMethod_InitWithConfig<WithStreamedUnaryMethod_Process<Service > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_Destroy<WithStreamedUnaryMethod_ExportTokenLibrary<WithStreamedUnaryMethod_Init<WithStreamedUnaryMethod_InitWithConfig<WithStreamedUnaryMethod_Process<Service > > > > > StreamedService;
};
