...
G2Product::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_ClearLastException_(G2Product_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Destroy_(G2Product_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetLastException_(G2Product_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetLastExceptionCode_(G2Product_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Init_(G2Product_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_License_(G2Product_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ValidateLicenseFile_(G2Product_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ValidateLicenseStringBase64_(G2Product_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Version_(G2Product_method_names[8], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status G2Product::Stub::ClearLastException(::grpc::ClientContext* context, const ::g2product::ClearLastExceptionRequest& request, ::g2product::ClearLastExceptionResponse* response) {
...
void G2Product::Stub::async::ClearLastException(::grpc::ClientContext* context, const ::g2product::ClearLastExceptionRequest* request, ::g2product::ClearLastExceptionResponse* response, std::function<void(::grpc::Status)> f) {
...
void G2Product::Stub::async::ClearLastException(::grpc::ClientContext* context, const ::g2product::ClearLastExceptionRequest* request, ::g2product::ClearLastExceptionResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::g2product::ClearLastExceptionResponse>* G2Product::Stub::PrepareAsyncClearLastExceptionRaw(::grpc::ClientContext* context, const ::g2product::ClearLastExceptionRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::g2product::ClearLastExceptionResponse>* G2Product::Stub::AsyncClearLastExceptionRaw(::grpc::ClientContext* context, const ::g2product::ClearLastExceptionRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status G2Product::Stub::GetLastException(::grpc::ClientContext* context, const ::g2product::GetLastExceptionRequest& request, ::g2product::GetLastExceptionResponse* response) {
...
void G2Product::Stub::async::GetLastException(::grpc::ClientContext* context, const ::g2product::GetLastExceptionRequest* request, ::g2product::GetLastExceptionResponse* response, std::function<void(::grpc::Status)> f) {
...
void G2Product::Stub::async::GetLastException(::grpc::ClientContext* context, const ::g2product::GetLastExceptionRequest* request, ::g2product::GetLastExceptionResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::g2product::GetLastExceptionResponse>* G2Product::Stub::PrepareAsyncGetLastExceptionRaw(::grpc::ClientContext* context, const ::g2product::GetLastExceptionRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::g2product::GetLastExceptionResponse>* G2Product::Stub::AsyncGetLastExceptionRaw(::grpc::ClientContext* context, const ::g2product::GetLastExceptionRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status G2Product::Stub::GetLastExceptionCode(::grpc::ClientContext* context, const ::g2product::GetLastExceptionCodeRequest& request, ::g2product::GetLastExceptionCodeResponse* response) {
...
void G2Product::Stub::async::GetLastExceptionCode(::grpc::ClientContext* context, const ::g2product::GetLastExceptionCodeRequest* request, ::g2product::GetLastExceptionCodeResponse* response, std::function<void(::grpc::Status)> f) {
...
void G2Product::Stub::async::GetLastExceptionCode(::grpc::ClientContext* context, const ::g2product::GetLastExceptionCodeRequest* request, ::g2product::GetLastExceptionCodeResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::g2product::GetLastExceptionCodeResponse>* G2Product::Stub::PrepareAsyncGetLastExceptionCodeRaw(::grpc::ClientContext* context, const ::g2product::GetLastExceptionCodeRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::g2product::GetLastExceptionCodeResponse>* G2Product::Stub::AsyncGetLastExceptionCodeRaw(::grpc::ClientContext* context, const ::g2product::GetLastExceptionCodeRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
G2Product::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< G2Product::Service, ::g2product::ClearLastExceptionRequest, ::g2product::ClearLastExceptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](G2Product::Service* service,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< G2Product::Service, ::g2product::GetLastExceptionRequest, ::g2product::GetLastExceptionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](G2Product::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< G2Product::Service, ::g2product::GetLastExceptionCodeRequest, ::g2product::GetLastExceptionCodeResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](G2Product::Service* service,
             ::grpc::ServerContext* ctx,
...
::grpc::Status G2Product::Service::ClearLastException(::grpc::ServerContext* context, const ::g2product::ClearLastExceptionRequest* request, ::g2product::ClearLastExceptionResponse* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status G2Product::Service::GetLastException(::grpc::ServerContext* context, const ::g2product::GetLastExceptionRequest* request, ::g2product::GetLastExceptionResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status G2Product::Service::GetLastExceptionCode(::grpc::ServerContext* context, const ::g2product::GetLastExceptionCodeRequest* request, ::g2product::GetLastExceptionCodeResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
