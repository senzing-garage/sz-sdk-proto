 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status AddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::g2engine::AddRecordResponseResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::g2engine::AddRecordResponseResponse>> AsyncAddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) {
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::g2engine::AddRecordResponseResponse>> PrepareAsyncAddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) {
    ...
    class async_interface {
     public:
      ...
      virtual void AddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest* request, ::g2engine::AddRecordResponseResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void AddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest* request, ::g2engine::AddRecordResponseResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
   ...
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::g2engine::AddRecordResponseResponse>* AsyncAddRecordRaw(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::g2engine::AddRecordResponseResponse>* PrepareAsyncAddRecordRaw(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status AddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::g2engine::AddRecordResponseResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::g2engine::AddRecordResponseResponse>> AsyncAddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) {
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::g2engine::AddRecordResponseResponse>> PrepareAsyncAddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) {
    ...
    class async final :
     ...
     public:
      void AddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest* request, ::g2engine::AddRecordResponseResponse* response, std::function<void(::grpc::Status)>) override;
      void AddRecord(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest* request, ::g2engine::AddRecordResponseResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::g2engine::AddRecordResponseResponse>* AsyncAddRecordRaw(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::g2engine::AddRecordResponseResponse>* PrepareAsyncAddRecordRaw(::grpc::ClientContext* context, const ::g2engine::AddRecordRequestRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status AddRecord(::grpc::ServerContext* context, const ::g2engine::AddRecordRequestRequest* request, ::g2engine::AddRecordResponseResponse* response);
  ...
  class WithAsyncMethod_AddRecord : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status AddRecord(::grpc::ServerContext* /*context*/, const ::g2engine::AddRecordRequestRequest* /*request*/, ::g2engine::AddRecordResponseResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestAddRecord(::grpc::ServerContext* context, ::g2engine::AddRecordRequestRequest* request, ::grpc::ServerAsyncResponseWriter< ::g2engine::AddRecordResponseResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_AddRecord() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::g2engine::AddRecordRequestRequest, ::g2engine::AddRecordResponseResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::g2engine::AddRecordRequestRequest* request, ::g2engine::AddRecordResponseResponse* response) { return this->AddRecord(context, request, response); }));}
    void SetMessageAllocatorFor_AddRecord(
        ::grpc::MessageAllocator< ::g2engine::AddRecordRequestRequest, ::g2engine::AddRecordResponseResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::g2engine::AddRecordRequestRequest, ::g2engine::AddRecordResponseResponse>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* AddRecord(
      ::grpc::CallbackServerContext* /*context*/, const ::g2engine::AddRecordRequestRequest* /*request*/, ::g2engine::AddRecordResponseResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  class WithStreamedUnaryMethod_AddRecord : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_AddRecord() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::g2engine::AddRecordRequestRequest, ::g2engine::AddRecordResponseResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::g2engine::AddRecordRequestRequest, ::g2engine::AddRecordResponseResponse>* streamer) {
    ...
    virtual ::grpc::Status StreamedAddRecord(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::g2engine::AddRecordRequestRequest,::g2engine::AddRecordResponseResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
